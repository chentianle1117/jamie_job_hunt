#!/usr/bin/env python3
"""Render all discovered-role resume.json + cover_letter.md -> PDFs + previews."""
import json, sys
...
BASE = Path(r"C:\Users\chent\Agentic_Workflows_2026\oracle-job-search\runs\2026-05-29_jamie3\discovered")
...
print("NEEDS FIX:", json.dumps(bad))
