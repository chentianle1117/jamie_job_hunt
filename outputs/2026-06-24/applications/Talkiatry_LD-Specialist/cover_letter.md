...
Dear Talkiatry Hiring Team,

**Learning and development** isn't just about delivering training content—from my experience, it's about creating a continuous cycle of collecting insights, analyzing data, and refining solutions that **develop people and strengthen organizational capability**. With a background in **HR**, **Organizational Development**, and **Program Management**, I have helped organizations design and implement data-informed strategies that strengthen both organizational growth and **employee and learner development**. I look forward to bringing a balanced blend of analytical and interpersonal strengths—using **facilitating live educational experiences**, **conducting training needs assessments**, and **collaborating with cross-functional stakeholders**—to **Talkiatry** as a **Learning & Development Specialist**.
...
My approach is grounded in my **MS in Applied Organizational Psychology (USC)**, which shaped how I think about people problems as systems: I **diagnose with data**, **collaborate cross-functionally on solutions**, and **track metrics to ensure real progress**. As an **analytical organizer with a growth mindset**, **Talkiatry**'s mission to expand access to high-quality mental health care by equipping clinicians and teams with the knowledge they need to succeed draws me in. I'd love to bring this methodology to your team.
