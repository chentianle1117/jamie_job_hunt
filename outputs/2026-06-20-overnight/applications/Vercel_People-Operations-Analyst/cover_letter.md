# Cover Letter — Vercel
## People Operations Analyst (Contract)
...
**Employee experience** isn't just about perks and events—from my experience, it's about creating a continuous cycle of collecting insights, analyzing data, and refining solutions that keep **clean data, fast turnaround, and a smooth employee experience** at the center of every lifecycle moment. With a background in **HR**, **Organizational Development**, and **Program Management**, I have helped organizations design and implement data-informed strategies that strengthen both organizational growth and **employee experience**. I look forward to bringing a balanced blend of analytical and interpersonal strengths—using **People Operations**, **HR data accuracy and reporting**, and **process improvement**—to **Vercel** as a **People Operations Analyst**.
